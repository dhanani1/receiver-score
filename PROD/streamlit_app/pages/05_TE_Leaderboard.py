# /05_TE_Leaderboard.py (updated)
import streamlit as st
import plotly.graph_objects as go
from utils import load_weekly, add_weekly_rates, aggregate_and_rate
import pandas as pd

st.set_page_config(page_title="TE Leaderboard", layout="wide")
st.title("TE Leaderboard")
...
mask = (df["Season"].eq(season) & df["Seas_Type"].eq(seas_type) &
        df["Week"].isin(weeks) & df["db_pos"].astype(str).eq("TE"))
